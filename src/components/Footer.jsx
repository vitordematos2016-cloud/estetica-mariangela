    ...
    <footer id="footer" className="mauve-surface pt-16 pb-8 px-6 md:px-12 border-t border-[#EBE1DC]">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
        ...
        <div className="lg:col-span-1">
          <Link to="/" onClick={handleLogoClick} className="inline-flex items-center gap-3 group mb-4">
            ...
            <span className="font-drama text-primary text-[15px] tracking-[0.15em] uppercase leading-tight mt-1">
              Mariangela<br/>Schinaider<br/>Estética
            </span>
          </Link>
          <p className="font-sans text-[14px] text-primary/80 leading-relaxed max-w-[250px] mb-6">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-4 font-sans text-[14px] text-primary/80">
            <li className="flex items-start gap-3 group">
              <WhatsAppIcon className="w-[18px] h-[18px] text-accent shrink-0 mt-0.5 group-hover:scale-110 transition-transform" />
            ...
            <li className="flex items-start gap-3 group">
              <InstagramIcon className="w-[18px] h-[18px] text-accent shrink-0 mt-0.5 group-hover:scale-110 transition-transform" strokeWidth={1.5} />
            ...
            <li className="flex items-start gap-3 group">
              <MapPin className="w-[18px] h-[18px] text-accent shrink-0 mt-0.5 group-hover:scale-110 transition-transform" strokeWidth={1.5} />
        ...
        <div>
          ...
          <ul className="space-y-2 font-sans text-primary/80 text-[14.5px]">
            {HOURS.map((h, i) => (
              <li key={i}>{h}</li>
            ))}
          </ul>
      ...
      {/* Copyright */}
      <div className="max-w-7xl mx-auto pt-8 border-t border-accent/20 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
